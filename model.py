...
class ResNet(nn.Module):
    ...
    def forward(self, inputs, last_feat=None):
        if self.training:
            ...
            #print(np.allclose(annotations_2,annotations_1)) #False : bu xiang deng 
            #print(annotations_1[0][0] ,(annotations_2[0][0]))
            #print("img_batch "  , len(img_batch_1) , len(img_batch_2)) # tensor len :2 ,2 
            #print(len(annotations_1) , len(annotations_2)) # len : 2 , 2
